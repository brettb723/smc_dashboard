...
from reports import work_orders_client, work_orders, unit_details, view_tables, unit_vacancy_details
...
def main():
    ...
    reports = {
        ...
        "Unit Vacancy Detail": unit_vacancy_details.unit_vacancy_detail
